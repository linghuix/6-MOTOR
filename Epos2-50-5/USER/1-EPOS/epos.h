...
#define PPMODE 0x01
#define MAX_ACC 200000
#define MAX_DEC 200000
#define MODE_NONE 0x00
#define MAX_F_ERR 5000
#define MAX_P_V 8000//4000
#define QDEC 100000
...
enum E_OBJ_MODE
{
    ...
    Position_Mode = (uint8_t)-1,
        //in
        PM_SET_VALUE = 0x2062,          
        //out
        Pos_Demand_Value = 0x6062,      
        
    Velocity_Mode = (uint8_t)-2,
        //in
        VM_SET_VALUE = 0x206B,
        //out
        Velocity_Demand_Value = 0x606B,

    Current_Mode  = (uint8_t)-3,
        //in
        CM_SET_VALUE = 0x2030,
        //out
        Current_Demand_Value = 0x606B,

    Diagnostic_Mode = (uint8_t)-4,
    
    Master_Encoder_Mode = (uint8_t)-5,
    
    Step_Direction_Mode = (uint8_t)-6,
    ...
    Profile_Velocity_Mode = (uint8_t)3,//目标位置有速度
        //IN
        //Controlword = 0x6040,
        Target_Velocity = 0x6040,          //目标位置的速度
