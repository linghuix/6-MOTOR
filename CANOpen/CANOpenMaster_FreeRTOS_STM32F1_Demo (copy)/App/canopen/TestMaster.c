...
/* index 0x1006 :   Communication / Cycle Period */
                    UNS32 TestMaster_obj1006 = 0x7A120;   /* 0x1388us */
...
/* index 0x1803 :   TPDO 4 .    Index 1803h-19FFh,  Transmit PDO Communication Parameter  
					...
					UNS32 TestMaster_obj1803_COB_ID_PDO = 0x40000481;//服务器，也就是需要修改的节点
...
/* index 0x1804 :   TPDO 4 .    Index 1804h-19FFh,  Transmit PDO Communication Parameter  
					...
					UNS32 TestMaster_obj1804_COB_ID_PDO = 0x40000482;//服务器，也就是需要修改的节点
					...
					subindex TestMaster_Index1804[] = 
					 {
						 ...
						 { RO, uint32, sizeof (UNS32), (void*)&TestMaster_obj1804_COB_ID_PDO, NULL },
...
/* index 0x1805 :   TPDO 4 .    Index 1805h-19FFh,  Transmit PDO Communication Parameter  
					...
					UNS32 TestMaster_obj1805_COB_ID_PDO = 0x40000483;//服务器，也就是需要修改的节点
                    ...
                    subindex TestMaster_Index1A00[] = 
                     {
                       ...
                       { RO, uint16, sizeof (UNS16), (void*)&TestMaster_1_mapped, NULL },
...
const indextable * TestMaster_scanIndexOD (CO_Data *d, UNS16 wIndex, UNS32 * errorCode)
{
	...
	switch(wIndex){
		...
		case 0x1A00: i = 20;break;/* PDO_TRS_MAP */
		...
		case 0x6040: i = 26;break;
		case 0x607A: i = 27;break;
		case 0x6060: i = 28;break;
		case 0x6065: i = 29;break;
		case 0x6070: i = 30;break;
		case 0x6075: i = 31;break;
		case 0x6080: i = 32;break;
